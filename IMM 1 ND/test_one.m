...
T = 2; % This is length of the time interval for which you're solving for, i.e. 2-(-1) = 3. 
...
%Plotting: 
tt = linspace(0, 2, 1000);% sampling points for exact solution 

for i=1:length(tt) 
ff(i)=F(tt(i)); 
end 

plot(tt,ff,'k') % plot the exact solution using the sampling values 
